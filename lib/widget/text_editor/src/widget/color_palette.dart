...
class _ColorPaletteState extends State<ColorPalette> {
  ...
  Widget build(BuildContext context) {
    ...
    // final textStyleModelTwo = TextEditorData.of(context).textStyleModelTwo;
    // final textStyleModelThree = TextEditorData.of(context).textStyleModelThree;
    return Row(
      children: [
        Expanded(
          flex: 0,
...
class _ColorPicker extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // final textStyleModelTwo = TextEditorData.read(context).textStyleModelTwo;
    // final textStyleModelThree = TextEditorData.of(context).textStyleModelThree;
    ...
    return GestureDetector(
      onTap: () {
        ...
        //   textStyleModelTwo.editTextColor(color);
        // } else {
        //   textStyleModelThree.editTextColor(color);
        // }
      },
      child: Container(
        width: 40,
