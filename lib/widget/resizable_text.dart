        ...
        child: Stack(
          children: <Widget>[
            ...
            Positioned(
              ...
              top: top - ballDiameter / 0.30,
              // left: left - ballDiameter / 2,
              left: left - ballDiameter / 0.15,
            ...
            Positioned(
              top: top - ballDiameter / 0.30,
              left: left + width - ballDiameter / 0.15,
              // left:
            ...
            Positioned(
              ...
              top: top + height - ballDiameter / 0.30,
              // left: left + width - ballDiameter / 2,
              left: left + width - ballDiameter / 0.15,
              child: ManipulatingBall(
                active: true,
            ...
            // center center
            Positioned(
              top: top + height / 2 - ballDiameter / 0.4,
              left: left + width / 2 - ballDiameter / 1.2,
              child: ManipulatingBall(
                active: true,
                isDone: widget.isDone!,
                onDrag: (dx, dy) {
                  setState(() {
                    ...
                    top = (top + dy) * angle.value / angle.value;
                    left = (left + dx) * angle.value / angle.value;
                  });
                },
